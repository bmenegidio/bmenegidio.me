    ...
    <div className={'bg-foreground -mt-5 rounded-3xl border-2 border-dashed border-gray-500 md:max-w-[550px]'}>
      <div className={'relative min-h-[300px] overflow-hidden p-10'}>
        <Heading variant={'body'}>
          Eu me chamo Bruno Menegidio, sou desenvolvedor web. Com uma paixão por inovação e desempenho, estou sempre em
          busca de novas maneiras de melhorar a experiência do usuário e otimizar o desenvolvimento de aplicações web.
        </Heading>
